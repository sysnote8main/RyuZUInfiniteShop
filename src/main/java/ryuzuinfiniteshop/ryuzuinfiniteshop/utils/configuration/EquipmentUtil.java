...
public class EquipmentUtil {
    private static final HashMap<Integer, EquipmentSlot> equipmentslots = new HashMap<Integer, EquipmentSlot>() {{
            put(2 * 9 + 2, EquipmentSlot.HEAD);
            put(3 * 9 + 2, EquipmentSlot.CHEST);
            put(4 * 9 + 2, EquipmentSlot.LEGS);
            put(5 * 9 + 2, EquipmentSlot.FEET);
            put(3 * 9 + 1, EquipmentSlot.HAND);
            put(3 * 9 + 3, EquipmentSlot.OFF_HAND);
    }};
