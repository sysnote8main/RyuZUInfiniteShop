...
public class SelectSearchItemGui extends ModeGui {
    ...
    public Inventory getInventory(ShopMode mode) {
        Inventory inv = Bukkit.createInventory(new ModeHolder(ShopMode.Search, this), 9, ChatColor.GREEN + "取引検索");
        ...
        inv.setItem(4, ItemUtil.getNamedItem(Material.GREEN_STAINED_GLASS_PANE, ChatColor.BLUE + "検索するアイテムを持ってクリック"));
