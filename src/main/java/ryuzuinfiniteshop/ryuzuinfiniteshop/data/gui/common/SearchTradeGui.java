...
public class SearchTradeGui extends TradesGui {
    ...
    public Inventory getInventory(ShopMode mode) {
        Inventory inv = Bukkit.createInventory(new SeachTradeHolder(mode, this, player, searchedTrade), 9 * 6, LanguageKey.INVENTORY_SEARCH_TRADE.getMessage(getPage()) + LanguageKey.INVENTORY_PAGE_NUMBER.getMessage(String.valueOf(getPage())));
