...
public enum LanguageKey {
    ...
    ITEM_SEARCH_INFO("アイテム登録とNPC名検索", "Item registration and NPC name search"),
    ITEM_SEARCH_REGISTER("クリック: 持っているアイテムを検索対象に登録", "Click: Register the held item for search"),
    ITEM_LORE_SEARCH_BY_ITEM("クリック: 登録したアイテムで検索", "Click: Search with the registered item"),
    ...
    COMMAND_SET_UNSEARCHABLE("指定されたワールドの全てのショップを検索不可にします", "Set all shops in the specified world to unsearchable"),
    ...
    MESSAGE_ERROR_INVALID_ENTITY("有効なエンティティタイプまたはMythicMobIDを入力して下さい", "Please input a valid entity type or MythicMob ID."),
    ...
    ITEM_TRADE_NORMAL("取引オプションと取引のアイテム化", "Trade set option and itemized"),
    ...
    ITEM_TRADE_LIMIT("ドロップ: 限界まで購入", "Drop: Buy to the limit"),
    ...
    ITEM_OPTIONS_MONEY_RECEIVE("受け取り", "Receive"),
    ITEM_OPTIONS_MONEY_PAY("支払い", "Pay"),
    ITEM_OPTIONS_MONEY_AMOUNT("取引金額: {0}", "Trade amount: {0}"),
    ITEM_OPTIONS_LIMIT_VALUE_BUYING("取引上限: {0}/{1}", "Trade limit: {0}/{1}"),
    ITEM_OPTIONS_LIMIT_VALUE_EDITTING("取引上限: {0}", "Trade limit: {0}"),
    ITEM_OPTIONS_RATE_SUCCESS("取引成功確率: {0}%", "Trade success rate: {0}%"),
    ITEM_OPTIONS_RATE_HIDE("確率を隠す", "Hide rate"),
    ITEM_OPTIONS_RATE_SHOW("確率を表示する", "Show rate"),
    ...
    ITEM_OPTIONS_RATE_CLICK("クリック: 切り替え", "Click: Toggle"),
    ITEM_OPTIONS_RATE_SHIFT("シフトクリック: チャットで値を入力", "Shift click: Enter value in chat"),
    ITEM_OPTIONS_MONEY_VALUE("お金: {0} {1}", "Money: {0} {1}"),
    ITEM_OPTIONS_MONEY_CLICK("クリック: 切り替え", "Click: Toggle"),
    ITEM_OPTIONS_MONEY_SHIFT("シフトクリック: チャットで値を入力", "Shift click: Enter value in chat"),
    ...
    ITEM_EDITOR_CAT_TYPE("模様の変更", "Change cat type"),
    ITEM_EDITOR_RABBIT_TYPE("模様の変更", "Change rabbit type"),
    ...
    MESSAGE_SHOP_UNSEARCHABLE("このショップの取引内容を見ることはできません", "You cannot view the trades of this shop"),
    MESSAGE_SHOP_LOCKED("このショップはロックされています", "This shop is locked"),
    ...
    ERROR_INVALID_LOADED_MYTHICMOBS("MythicMobsがロードされていません ID: {0}", "MythicMobs is not loaded ID: {0}"),
    ERROR_INVALID_LOADED_VAULT("Vaultがロードされていません ID: {0}", "Vault is not loaded ID: {0}"),
    ERROR_MYTHICMOBS_INVALID_ID("存在しないMMIDです ID: {0}", "Invalid MMID ID: {0}"),
    ERROR_CITIZENS_INVALID_ID("存在しないCitizens NPCです ID: {0}", "Invalid Citizens NPC: {0}"),
    MESSAGE_ERROR_NOT_EXIST_PLAYER("そのプレイヤーは存在しません", "That player does not exist"),
    MESSAGE_ERROR_NOT_EXIST_WORLD("そのワールドは存在しません", "That world does not exist"),
    MESSAGE_ERROR_INVALID_ARGUMENTS("無効な引数です", "Invalid arguments"),
    MESSAGE_SEARCH_CANCELLED("検索をキャンセルしました", "Search cancelled"),
    MESSAGE_ERROR_TRADE_REQUIRED_GEM("トレード圧縮宝石を持った状態で実行してください", "Please execute while holding a Trade Compression Gem"),
    MESSAGE_SET_SEARCHABLE("指定したワールドの全てのショップを検索可にしました", "All shops in the specified world have been made searchable"),
    MESSAGE_SET_UNSEARCHABLE("指定したワールドの全てのショップを検索不可にしました", "All shops in the specified world have been made unsearchable"),
    ...
    ITEM_SHOP_COMPRESSION_GEM_NAME("ショップ圧縮宝石: ", "Shop compression gem: "),
    ...
    MESSAGE_ERROR_NOT_BOUGHT_EVERYTHING("すべてを購入できませんでした", "Couldn't buy everything"),
    MESSAGE_ERROR_INVENTORY_FULL("インベントリに十分な空きがありません", "Inventory is full"),
    ITEM_SETTINGS_TRADE_SET_OPTION("クリック: 取引オプション設定", "Click: Set trade option"),
    ...
    MESSAGE_NPC_NOT_CITIZEN("そのEntityはCitizenのNPCではありません", "The selected entity is not a Citizen NPC"),
    MESSAGE_NPC_ALREADY_REGISTERED("すでに登録されているNPCです", "This NPC is already registered"),
    MESSAGE_NPC_REGISTRATION_COMPLETE("登録が完了しました", "Registration completed successfully"),
    MESSAGE_NPC_TO_REGISTER("登録したいCitizenのNPCを右クリックしてください", "Please right-click on the Citizen NPC you wish to register"),
    ...
    MESSAGE_CANCEL_INPUT("20秒待つか'Cancel'と入力することでキャンセルことができます", "You can cancel by waiting for 20 seconds or inputting 'Cancel'."),
