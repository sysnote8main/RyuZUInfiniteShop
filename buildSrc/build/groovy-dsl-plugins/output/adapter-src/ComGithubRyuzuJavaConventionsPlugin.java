...
/**
 * Precompiled com.github.ryuzu.java-conventions script plugin.
 **/
public class ComGithubRyuzuJavaConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_ComGithubRyuzuJavaConventions").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ComGithubRyuzuJavaConventions").asSubclass(BasicScript.class);
